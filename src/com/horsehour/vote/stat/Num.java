...
/*
 * Originally from http://www.iro.umontreal.ca/~simardr/ssj/indexe.html
 */
...
public class Num {
	 ...
	 * <SPAN CLASS="MATH">= 2<SUP>j</SUP></SPAN>, for
	...
	/**
	 * Evaluates a series of Chebyshev polynomials <SPAN CLASS="MATH"><I>T</I>
	 * <SUB>j</SUB></SPAN> at <SPAN CLASS="MATH"><I>x</I></SPAN> over the basic
	 * interval <SPAN CLASS="MATH">[- 1, &nbsp;1]</SPAN>. It uses the method of
	 * Clenshaw, i.e., computes and returns
	 * 
	 * <P>
	 * </P>
	 * <DIV ALIGN="CENTER" CLASS="mathdisplay"> <I>y</I> =
	 * <IMG ALIGN="MIDDLE" BORDER="0" SRC="Numimg4.png" ALT=
	 * "$\displaystyle {\frac{{a_0}}{2}}$"> + &sum;<SUB>j=1</SUB><SUP>n</SUP>
	 * <I>a</I><SUB>j</SUB><I>T</I><SUB>j</SUB>(<I>x</I>). </DIV>
	 * <P>
	 * </P>
	 * 
	 * @param a
	 ...
	 * 
	 * @param x
	 *            the parameter of the <SPAN CLASS="MATH"><I>T</I>
	 *            <SUB>j</SUB></SPAN> functions
	 * 
	 * @return the value of a series of Chebyshev polynomials
