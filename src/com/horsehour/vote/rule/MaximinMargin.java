...
public class MaximinMargin<T> extends OptimizedPositionalRule<T> {
	@Override
	public void optimize(ProfileList<T> preferences, double normalization) throws IloException {
		...
		/*
		 * TODO this currently is broken if the preference profile has no way of
		 * being consistent with the ground truth. See the implementation in min
		 * mistakes.
		 */
